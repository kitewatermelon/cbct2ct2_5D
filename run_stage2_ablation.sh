...
PYTHONPATH=. python stage2_vdm.py --batch_size 8 \
  ...
  --ct_ckpt   ${CKPT}/1_vqvae_ct_n1_cpr4_img128/best.pt \
  --cbct_ckpt ${CKPT}/1_vqvae_cbct_n1_cpr4_img128/best.pt \
...
PYTHONPATH=. python stage2_vdm.py --batch_size 8 \
  ...
  --ct_ckpt   ${CKPT}/1_vqvae_ct_n3_cpr4_img128/best.pt \
  --cbct_ckpt ${CKPT}/1_vqvae_cbct_n3_cpr4_img128/best.pt \
...
PYTHONPATH=. python stage2_vdm.py --batch_size 8 \
  ...
  --ct_ckpt   ${CKPT}/1_vqvae_ct_n5_cpr4_img128/best.pt \
  --cbct_ckpt ${CKPT}/1_vqvae_cbct_n5_cpr4_img128/best.pt \
...
PYTHONPATH=. python stage2_vdm.py --batch_size 8 \
  ...
  --ct_ckpt   ${CKPT}/1_vqvae_ct_n7_cpr4_img128/best.pt \
  --cbct_ckpt ${CKPT}/1_vqvae_cbct_n7_cpr4_img128/best.pt \
...
PYTHONPATH=. python stage2_vdm.py --batch_size 8 \
  ...
  --ct_ckpt   ${CKPT}/1_vqvae_ct_n9_cpr4_img128/best.pt \
  --cbct_ckpt ${CKPT}/1_vqvae_cbct_n9_cpr4_img128/best.pt \
...
PYTHONPATH=. python stage2_vdm.py --batch_size 8 \
  ...
  --ct_ckpt   ${CKPT}/1_vqvae_ct_n5_cpr8_img128/best.pt \
  --cbct_ckpt ${CKPT}/1_vqvae_cbct_n5_cpr8_img128/best.pt \
...
PYTHONPATH=. python stage2_vdm.py --batch_size 8 \
  ...
  --ct_ckpt   ${CKPT}/1_vqvae_ct_n5_cpr2_img128/best.pt \
  --cbct_ckpt ${CKPT}/1_vqvae_cbct_n5_cpr2_img128/best.pt \
